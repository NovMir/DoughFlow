...
const Recipe = require('../models/recipe'); // Ensure this is correctly pointing to your Recipe model

router.get('/view', async (req, res) => {
    try {
        const recipes = await Recipe.find(); // Make sure this finds recipes correctly
        res.render('recipes', { recipes: recipes }); // Pass 'recipes' to your EJS template
    } catch (error) {
